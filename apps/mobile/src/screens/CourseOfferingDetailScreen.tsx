            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.container}>
                    <View style={styles.headerBox}>
                        ...
                        <Text style={styles.status}>
                            ...
                            {(() => {
                                ...
                                return <Text style={[styles.statusValue, { color }]}>{label}</Text>;
                            })()}
                        </Text>
                    </View>
                    ...
                    <View style={styles.infoBox}>
                        ...
                        <Text style={styles.infoItem}>Sĩ số: {data.registered}/{data.capacity} </Text>
                        {data.description && (
                            <Text style={styles.infoItem}>
                        ...
                        <Text style={styles.infoItem}>
                            Thời gian học:{" "}
                            {new Date(data.semester.start_date).toLocaleDateString(
                                "vi-VN"
                            )}{" "}
                            →{" "}
                            {new Date(data.semester.end_date).toLocaleDateString(
                                "vi-VN"
                            )}
                        </Text>
                    </View>
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.card}>
                                ...
                                >
                                    ...
                                    />
                                    <Text style={styles.infoItem}>
                                        Nhóm: {data.practice_group.group_number} |
                                        Sĩ số: {data.practice_group.registered}/{data.practice_group.capacity}
                                    </Text>
                                </View>
...
const styles = StyleSheet.create({
    ...
    sectionSubtitle: { fontSize: 16, fontWeight: "600", color: "#374151", marginTop: 8, marginBottom: 4 },
    ...
    email: { fontSize: 14, color: "#6B7280", marginBottom: 6, maxWidth: "95%", lineHeight: 18 },
    button: {
        flexDirection: "row",
        alignItems: "center",
    ...
    warningText: { color: "#B91C1C", fontSize: 14, marginLeft: 6, flex: 1, flexWrap: "wrap" },
});
